...
Container::make('post_meta', 'Datos del libro')
	...
	->add_fields(array(
		...
		Field::make('text', 'tender_book_section', __('Sección de la biblioteca'))
			->set_required(true),
		...
		Field::make('text', 'tender_book_language', __('Idioma'))
			->set_default_value('Castellano'),
